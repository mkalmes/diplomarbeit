...
Nachdem die Regionemarkierung abgeschlossen ist, enthält $\mathit{work}$ die numerischen Werte der Regionen. In
 ...
 \autoref{alg:arlabeling-neighbour-case2-1}, zusammen. Für $c_{1} = 5$, $c_{2} = 6$ und $\mathit{wk\_max}_{0} = 24$ ist
...
Für $c_{1} = 2$, $c_{2} = 40999$, $\mathit{lxsize}_{0} = 5$ und $\mathit{lysize}_{0} = 4$ ist die Wachstumsrate von
