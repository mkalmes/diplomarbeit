...
Anstatt die Regionen anhand ihrer Markierungen im Eingangssignal zu speichern, verwendet ARToolKitPlus dazu eine eigene
 ...
 generiert und das Verfahren in \autoref{sec:} erläutert.
...
Im zweiten Schritt der Fiducial Detection wird der Umriss einer Region bestimmt. ARToolKitPlus verwendet dazu die Liste
 ...
 untersucht. Falls die Fläche einer Region zu klein oder zu groß zur Analyse ist, wird sie verworfen. Anschliessend
...
In diesem Schritt wird eine geschlossene Kontur untersucht, ob es sich um ein Rechteck handelt.
