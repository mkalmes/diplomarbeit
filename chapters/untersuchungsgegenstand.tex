...
ARToolKitPlus erkennt Marken, indem ein Bildsignal zuerst in ein Binärbild gewandelt wird um danach zusammenhängende
 Bildregionen aufzufinden. Diese Regionen werden isoliert betrachtet und daraufhin untersucht, ob es sich dabei um ein
 Rechteck handelt. Dazu wird \autoref{fiducialdetection} und \autoref{rectanglefitting} aus der
...
Bei Fiducial Detection wird das Bildsignal von links nach rechts und von oben nach unten untersucht. Um eine Kante in
 ...
 handelt, wird die Gruppe verworfen, da sie sich nicht zur Erkennung eignet.
