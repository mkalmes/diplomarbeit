...
Da ein Liniensegment aus zwei zufällig ausgewählten \glspl{edgel} besteht, können diese \gls{edgel} und die
 ...
 \autoref{alg:findlinesegments7} in Zeile
 ...
 \autoref{alg:findlinesegments7} ist in $\mathit{presentLine}$ ein neuer Start- und Endpunkt gespeichert.
...
In \autoref{alg:findlinesegments8} wird nun geprüft, ob der Start- und Endpunkt vertauscht ist. Dazu wird der Winkel
 ...
 Endpunkt in Zeile \ref{alg:findlinesegments8-newstart-start}--\ref{alg:findlinesegments8-newstart-end} getauscht. Im
 Anschluss daran, wird in Zeile \ref{alg:findlinesegments8-save-start}--\ref{alg:findlinesegments8-save-end} die
