...
Mit \textproc{intersection} wird der Schnittpunkt zweier Linien berechnet. Dazu benötigt das Verfahren
 \autoref{alg:linesegmenintersection} eine linke und eine rechte Linie. In Zeile
 \ref{alg:linesegmenintersection-var-start}--\ref{alg:linesegmenintersection-var-end} werden die Punkte der
