...
In Zeile \ref{alg:isedgelnearline-return} wird als Rückgabewert, abhängig vom Vergleich der Distanz, wahr oder falsch
 zurückgegebn. Bleibt der Abstand des \gls{edgel} zur Linie unter $0.75$ wird wahr an die aufrufende Methode
...
\input{alg/analyse-hirzer/datastructure-linesegmentremoveline}
