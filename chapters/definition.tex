...
Bis heute ist \gls{AR} nicht eindeutig definiert, obwohl die ersten Untersuchung von \citeauthor{sutherland} bereits
 ...
 (Vgl. \autoref{fig:mixedreality}), welches reale und virtuelle Objekte gemeinsam auf einem Bildschirm darstellt. Je
 weiter wir uns von dem Extrem der realen Welt entfernen, desto weiter nähren wir uns einem Extrem der virtuellen Welt
 an.
\begin{figure}[!ht]
	\centering
