...
Die Anzahl der \glspl{edgel} in einem Speicherblock werden durch \autoref{alg:edgelpool-count} ermittelt. Als Parameter
 wird der Zeiger $p$ übergeben und in Zeile
