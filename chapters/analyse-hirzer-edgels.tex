...
Mithilfe von \autoref{alg:vectordotproduct} kann die Orientierung der beiden \gls{edgel} überprüft werden. Zwei
 \gls{edgel} sind dann kompatibel, wenn der Winkel zwischen den Vektoren nicht größer als $67.5^\circ$
 ist\footcite[Vgl.][S.~417]{clarke96}. Dies wird durch \autoref{eq:edgeliscompatible} in
...
\input{alg/analyse-hirzer/edgelpool-getmemorypools}

\input{alg/analyse-hirzer/edgelpool-getmemorypool}
...
\input{alg/analyse-hirzer/edgelpool-addedgel}
...
\input{alg/analyse-hirzer/edgelpool-getedgel}
