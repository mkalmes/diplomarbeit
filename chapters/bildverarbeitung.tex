...
Bei der sequentiellen Regionenmakierung\footcite[Vgl.][S.~200--206]{burger05} wird ein Binärbild in zwei Schritten
 ...
 Schritt werden mehrfache Makierungen, sogenannte Kollisionen, für eine Region aufgelöst.
...
Wenn alle Nachbarn Hintergrundpixel sind (\autoref{labeling-all-background}), wird eine Makierung an Position $(u,v)$
 ...
 dargestellt wird (Vgl.~\autoref{fig:kollision}).
\begin{figure}[!ht]
	\centering
	...
	\label{fig:kollision}
\end{figure}
Dem \gls{pixel} an Position $(u,v)$ wird eine Makierung eines Nachbarn zugewiesen und die Kollision wird vermerkt. Nach
