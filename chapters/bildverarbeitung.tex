...
Die Chromakomponenten $Cb$ und $Cr$ von YCbCr sind, wie bei YUV, Differenzwerte des Blau- und Rotanteil und der Luminanz. Der Unterschied zwischen YUV und YCbCr besteht in der unterschiedlichen Berechnung der \gls{chrominanz} und ist in \citeauthor{burger06}\footcite[][S.265--266]{burger06} beschrieben.
...
besteht aus den den drei Luminanzbildern $I_R$, $I_G$ und $I_B$ (Abb.~\ref{fig:planareAnordnung}). Der Zugriff auf ein \gls{pixel} erfolgt über das Auslesen aller drei Arrays, wie in \citeauthor{burger06}\footcite[Vgl.][S.~235--236]{burger06} beschrieben. Der Zugriff erfolgt durch
...
$Red()$, $Green()$ und $Blue()$ sind abhänging vom eingesetzten Format\footcite[Vgl.][S.~236--237]{burger06}.
