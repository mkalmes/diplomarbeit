...
Bevor die \gls{AR}-Verfahren besprochen werden, werden die grundlegenden Aspekte der digitalen Bildverarbeitung
 benannt, die in den nachfolgenden Kapiteln benötigt werden. Dabei wird kein vollständiger Überblick über Digitale
 Bildverarbeitung vermittelt, sondern nur Bereiche besprochen, die für die Untersuchung der \gls{AR} berücksichtigt
 werden müssen.
...
\begin{figure}[!ht]
	...
	\caption{Filter und Randbehandlung. Das Originalbild \subref{fig:randbeispiel-original} wird je nach eingesetzten
...
Zuerst muss das Binärbild zeilenweise von oben nach unten auf das Vorhandensein von Vordergrundpixeln untersucht werden.
