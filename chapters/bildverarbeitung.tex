...
\begin{figure}[!ht]
	...
	\caption{
		Ein farbiges Bild \subref{fig:rgbLenna-Farbe} wird im RGB Farbraum in seine Komponenten Rot
...
\begin{figure}[!ht]
	...
	\caption{
		Im YUV Farbraum wird ein Bild \subref{fig:yuvLenna-Farbe} in Luminanz $Y$ \subref{fig:yuvLenna-Y},
