...
Wir wissen durch \autoref{alg:arlabeling-regionlabeling}, dass $I(u,v)$ ein Vordergrundpixel ist, dem wir an dieser
 ...
 Markierung wie $N_3$ und müssen nicht weiter untersucht werden.
...
Beim zweiten Fall wird die Markierung $N_4$ betrachtet. Da $N_3$ keine Markierung aufweist, können nur $N_1$ und $N_2$
 ...
 handeln, die durch \autoref{alg:} besonders behandelt wird.
...
\label{par:fall_4_}
Der vierte Fall untersucht den letzten, und einzigen, Nachbarn $N_1$. Alle anderen Nachbarn sind keine Vordergrundpixel
 und es besteht keine Kollision. Die Markierung von $N_1$ wird für $I(u,v)$ übernommen.
% paragraph fall_4_ (end)

\paragraph{5. Fall:} % (fold)
\label{par:fall_5_}
Im letzten Fall sind alle Nachbarn Hintergrundpixel und $I(u,v)$ wird eine neue Markierung zugewiesen.
