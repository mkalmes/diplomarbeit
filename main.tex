...
\label{cha:abstract}
The diploma thesis \emph{Marker-basierte Tracking-Verfahren für Augmented Reality An\-wen\-dun\-gen unter iOS 4} asks
 the question whether tracking systems are practical on mobile devices. The study design involved the implementation of
 a tracking system by \citeauthor{hirzer08}, which was then compared with ARToolKitPlus, which is another widely used
 tracking system.
